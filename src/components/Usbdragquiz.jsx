...
const USB_TYPES = [
  {
    id: "usbA",
    name: "USB-A",
    img: "/src/assets/usbA.png",
    color: "#378ADD",
  },
  {
    id: "usbB",
    name: "USB-B",
    img: "/src/assets/usbB.png",
    color: "#1D9E75",
  },
  {
    id: "usbC",
    name: "USB-C",
    img: "/src/assets/usbC.png",
    color: "#EFB800",
  },
  {
    id: "microUsb",
    name: "Micro USB",
    img: "/src/assets/microUsb.png",
    color: "#D85A30",
  },
];
...
const QUESTIONS = [
  {
    id: 1,
    characteristic: "Reversible oval connector. Found on modern laptops, phones, and tablets. Supports up to 240W charging and 40Gbps data.",
    answer: "usbC",
  },
  {
    id: 2,
    characteristic: "Rectangular connector. The most common USB type for decades. Found on computers, chargers, and USB hubs.",
    answer: "usbA",
  },
  {
    id: 3,
    characteristic: "Small trapezoid connector. Common on older Android phones and budget devices. Replaced by USB-C in most modern devices.",
    answer: "microUsb",
  },
  {
    id: 4,
    characteristic: "Square connector with beveled corners. Used on printers, scanners, and other peripherals. Rarely seen on consumer devices today.",
    answer: "usbB",
  },
  {
    id: 5,
    characteristic: "This connector supports Thunderbolt 4 and DisplayPort Alt Mode — meaning you can plug a 4K monitor directly into it with a single cable.",
    answer: "usbC",
  },
  {
    id: 6,
    characteristic: "You'll find this port on almost every desktop PC and laptop made between 2000 and 2020. USB flash drives and keyboards use this to connect.",
    answer: "usbA",
  },
  {
    id: 7,
    characteristic: "This connector was the standard charging port for Android phones from roughly 2007 to 2017. It has a top and bottom — you can't plug it in upside down.",
    answer: "microUsb",
  },
  {
    id: 8,
    characteristic: "This connector is almost exclusively found on the device end of a printer or scanner cable. It has a distinctly boxy, almost square shape.",
    answer: "usbB",
  },
];
    ...
    return (
      <div style={{
        ...
        <div style={{ fontSize: "14px", color: "rgba(255,255,255,0.5)", marginBottom: "28px" }}>
          {score === QUESTIONS.length
            ? "Perfect score! You know your USB types."
            : score >= QUESTIONS.length / 2
            ? "Good effort! Review the ones you missed."
            : "Keep studying — USB types can be tricky!"}
        </div>
        <button
          ...
          return (
            <div
              ...
              style={{
                ...
                border: isCorrectAndShown
                  ? "1.5px solid #1D9E75"
                  : isWrong
                  ? "1.5px solid #D85A30"
                  : dragging === usb.id
                  ? `1.5px solid ${usb.color}`
            ...
            >
              <img
                src={resolveImg(usb.id)}
                alt={usb.name}
                draggable={false}
                style={{ width: "64px", height: "48px", objectFit: "contain", pointerEvents: "none" }}
              />
              <span style={{ fontSize: "11px", fontWeight: "500", color: "rgba(255,255,255,0.6)" }}>
                {usb.name}
              </span>
            </div>
          );
